...
function DocsButton({url, label}) {
  return (
    <a
      href={url}
      target="_blank"
      className="inline-flex items-center px-5 py-2 bg-white rounded-full shadow hover:opacity-80"
      rel="noreferrer"
    >
      {label}
      <ExternalIcon />
...
function BoxFallback() {
  return (
    <div className="p-12 text-gray-900 bg-white shadow-xl rounded-xl h-60"></div>
  );
}
...
function TemplateLinks() {
  ...
  return (
    <div className="p-12 text-gray-900 bg-white shadow-xl md:p-12 rounded-xl">
      <p className="mb-4 font-medium uppercase text-md">
      ...
      <ul>
        <li className="mb-4">
          <Link
            ...
            className="font-medium text-blue-700 text-md hover:underline"
          >
            Collection template
          </Link>
        </li>
